...
const FAQSection = memo(() => {
  const faqItems = [
    ...
    {
      question: "Извършвате ли лабораторни изследвания?",
      answer: "Да, извършваме всякакви лабораторни изследвания, включително и на място на домашен адрес. Освен лабораторни изследвания извършваме всякакви интравенозни инфузии, подкожни и интрамускулни инжекции, поставяне на ваксини."
    },
    {

...
const MedicalEquipment = () => {
  ...
  return <section id="equipment" className="section-padding bg-gray-50 py-[40px]">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {equipment.map((item, index) => <Card key={index} className="hover:shadow-lg transition-shadow">
        ...
        <div className="mt-12 text-center">
          <Button className="bg-primary hover:bg-primary-dark text-gray-900 font-medium" size="lg" asChild>

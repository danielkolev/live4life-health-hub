          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection animation="slide-right" delay={200}>
              <article className="order-2 lg:order-1">
                ...
                <Button asChild className="bg-primary hover:bg-primary-dark text-white hover-lift">
                  <Link to="/about" className="flex items-center">
                    Научете повече за нас <ArrowRight className="ml-2 h-4 w-4 icon-bounce" aria-hidden="true" />
                  </Link>
                </Button>
              </article>
            </AnimatedSection>
            ...
            <AnimatedSection animation="slide-left" delay={400}>
              <aside className="order-1 lg:order-2">
                <div className="relative">
                  ...
                  <figure className="relative rounded-lg overflow-hidden w-4/5 mx-auto hover-scale">

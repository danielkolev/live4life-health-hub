        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="border-white text-white bg-secondary-dark">
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in">
            <img src="/lovable-uploads/9dcd0c65-d1b0-4b55-9ab0-4a786995dfd0.png" alt="Live4Life Medical Center Logo" className="max-w-xs md:max-w-sm" />
          </div>
        </div>
      </div>

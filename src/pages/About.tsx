...
const About = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <div className="pt-20">
        ...
        <section className="section-padding bg-white py-0">
          <div className="container-custom">            
            ...
            <div className="my-12">
              ...
              <div className="max-w-4xl mx-auto">
                <Carousel className="w-full">
                  <CarouselContent>
                    {clinicImages.map((image, index) => <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                        <div className="p-1">
        ...
        {/* Mission & Vision */}
        <section className="section-padding py-[5px]">
          <div className="container-custom">
        ...
        {/* Values */}
        <section className="section-padding bg-gray-50 py-[29px]">
          <div className="container-custom">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="flex flex-col justify-center">
                  ...
                  <div className="flex justify-center md:justify-start">
                    <img src="/lovable-uploads/2d8e2758-f909-4ca8-84de-9598b438c871.png" alt="Лого Live4Life" className="h-20" />
                  </div>
                </div>
